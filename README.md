...
5) Build a local version of your site by executing `hugo server`. You can see the site by navigating to `http://localhost:1313/blog/` (actual URL will be outputted in the CLI) in a browser.
